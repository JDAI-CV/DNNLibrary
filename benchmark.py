...
def run(onnx, onnx2daq, dnn_benchmark, output_name, number_running):
    daq = "temp.daq"
    ...
    os.system('adb shell "LD_LIBRARY_PATH=/data/local/tmp/ /data/local/tmp/dnn_benchmark /data/local/tmp/{} {} {}"'.format(os.path.basename(daq), output_name, number_running))
...
if __name__ == '__main__':
    ...
    actual = run(args.onnx, args.onnx2daq, args.dnn_benchmark, args.output, args.number_running)

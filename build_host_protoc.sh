#! /usr/bin/env bash
# Modified from https://github.com/pytorch/pytorch/blob/master/scripts/build_host_protoc.sh
##############################################################################
...
ROOT="$( pwd -P)"
BUILD_ROOT=${BUILD_ROOT:-"$ROOT/build_host_protoc"}
...
cmake "$ROOT/third_party/protobuf/cmake" ${CMAKE_ARGS[@]}

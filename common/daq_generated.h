...
/// Int8 is deprecated, but int8_data in table Tensor is used, since a Tensor
/// just stores value, not care about quantization method
...
inline const DataType (&EnumValuesDataType())[10] {
    static const DataType values[] = {
        ...
        DataType::Bool8,         DataType::QUANT8_ASYMM,
        DataType::QUANT8_SYMM,   DataType::QUANT8_SYMM_PER_CHANNEL,
        DataType::QUANT16_ASYMM, DataType::QUANT16_SYMM};
    return values;
}
...
inline const char *const *EnumNamesDataType() {
    static const char *const names[] = {
        ...
        "Int32",         "Float16",
        "Bool8",         "QUANT8_ASYMM",
        "QUANT8_SYMM",   "QUANT8_SYMM_PER_CHANNEL",
...
inline const FuseCode (&EnumValuesFuseCode())[4] {
    static const FuseCode values[] = {FuseCode::None, FuseCode::Relu,
                                      FuseCode::Relu1, FuseCode::Relu6};
    return values;
}

inline const char *const *EnumNamesFuseCode() {
    static const char *const names[] = {"None", "Relu", "Relu1", "Relu6",
                                        nullptr};
    return names;
}
...
struct Tensor FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) &&
               ...
               verifier.VerifyVector(int32_data()) && verifier.EndTable();
    }
};
...
struct TensorBuilder {
    ...
    void add_data_type(DataType data_type) {
        fbb_.AddElement<int8_t>(Tensor::VT_DATA_TYPE,
                                static_cast<int8_t>(data_type), 0);
    }
    void add_int8_data(
        flatbuffers::Offset<flatbuffers::Vector<uint8_t>> int8_data) {
        fbb_.AddOffset(Tensor::VT_INT8_DATA, int8_data);
    }
    void add_float32_data(
        flatbuffers::Offset<flatbuffers::Vector<float>> float32_data) {
    ...
    void add_float16_data(
        flatbuffers::Offset<flatbuffers::Vector<uint16_t>> float16_data) {
        fbb_.AddOffset(Tensor::VT_FLOAT16_DATA, float16_data);
    }
    void add_bool8_data(
        flatbuffers::Offset<flatbuffers::Vector<uint8_t>> bool8_data) {
        fbb_.AddOffset(Tensor::VT_BOOL8_DATA, bool8_data);
    }
    void add_int32_data(
        flatbuffers::Offset<flatbuffers::Vector<int32_t>> int32_data) {
...
inline flatbuffers::Offset<Tensor> CreateTensorDirect(
    ...
    const std::vector<uint32_t> *shape = nullptr, const char *name = nullptr,
    ...
    return DNN::CreateTensor(
        _fbb, data_type, int8_data ? _fbb.CreateVector<uint8_t>(*int8_data) : 0,
...
struct QuantInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_NAME = 4, VT_DATA_TYPE = 6, VT_SCALES = 8, VT_ZERO_POINT = 10 };
    const flatbuffers::String *name() const {
        return GetPointer<const flatbuffers::String *>(VT_NAME);
    }
    DataType data_type() const {
    ...
    /// a float32 array of scales, the length will be 1 for non per-channel
    /// quantization, and be channelDim for per-channel quantization
    const flatbuffers::Vector<float> *scales() const {
        return GetPointer<const flatbuffers::Vector<float> *>(VT_SCALES);
    }
    int32_t zero_point() const { return GetField<int32_t>(VT_ZERO_POINT, 0); }
    bool Verify(flatbuffers::Verifier &verifier) const {
...
struct QuantInfoBuilder {
    ...
    void add_data_type(DataType data_type) {
        fbb_.AddElement<int8_t>(QuantInfo::VT_DATA_TYPE,
                                static_cast<int8_t>(data_type), 0);
    }
...
inline flatbuffers::Offset<QuantInfo> CreateQuantInfoDirect(
    ...
    DataType data_type = DataType::Float32,
    const std::vector<float> *scales = nullptr, int32_t zero_point = 0) {
    return DNN::CreateQuantInfo(
        _fbb, name ? _fbb.CreateString(name) : 0, data_type,
        scales ? _fbb.CreateVector<float>(*scales) : 0, zero_point);
}

struct Input FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_SHAPE = 4, VT_NAME = 6 };
    const flatbuffers::Vector<uint32_t> *shape() const {
        return GetPointer<const flatbuffers::Vector<uint32_t> *>(VT_SHAPE);
    }
    const flatbuffers::String *name() const {
...
struct InputBuilder {
    ...
    explicit InputBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
struct StridedSliceBuilder {
    ...
    void add_strides(
        flatbuffers::Offset<flatbuffers::Vector<int32_t>> strides) {
    ...
    void add_shrink_axis_mask(int32_t shrink_axis_mask) {
        fbb_.AddElement<int32_t>(StridedSlice::VT_SHRINK_AXIS_MASK,
                                 shrink_axis_mask, 0);
    }
...
inline flatbuffers::Offset<StridedSlice> CreateStridedSliceDirect(
    ...
    const std::vector<int32_t> *strides = nullptr, int32_t begin_mask = 0,
    int32_t end_mask = 0, int32_t shrink_axis_mask = 0,
    const char *output = nullptr) {
    return DNN::CreateStridedSlice(
        _fbb, input ? _fbb.CreateString(input) : 0,
        starts ? _fbb.CreateVector<int32_t>(*starts) : 0,
        ends ? _fbb.CreateVector<int32_t>(*ends) : 0,
        strides ? _fbb.CreateVector<int32_t>(*strides) : 0, begin_mask,
        end_mask, shrink_axis_mask, output ? _fbb.CreateString(output) : 0);
}

struct BatchToSpace FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_INPUT = 4, VT_BLOCK_SIZES = 6, VT_OUTPUT = 8 };
    const flatbuffers::String *input() const {
        return GetPointer<const flatbuffers::String *>(VT_INPUT);
    }
...
struct BatchToSpaceBuilder {
    ...
    void add_block_sizes(
        flatbuffers::Offset<flatbuffers::Vector<int32_t>> block_sizes) {
...
struct SpaceToBatch FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_INPUT = 4, VT_BLOCK_SIZES = 6, VT_PADS = 8, VT_OUTPUT = 10 };
    const flatbuffers::String *input() const {
        return GetPointer<const flatbuffers::String *>(VT_INPUT);
    }
    const flatbuffers::Vector<int32_t> *block_sizes() const {
...
inline flatbuffers::Offset<SpaceToBatch> CreateSpaceToBatchDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const char *input = nullptr,
    const std::vector<int32_t> *block_sizes = nullptr,
    const std::vector<int32_t> *pads = nullptr, const char *output = nullptr) {
...
struct Conv2DBuilder {
    ...
    explicit Conv2DBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<Conv2D> CreateConv2DDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const char *input = nullptr,
    const char *weight = nullptr, const char *bias = nullptr,
    const std::vector<int32_t> *pads = nullptr,
    const std::vector<int32_t> *strides = nullptr,
    FuseCode fuse = FuseCode::None, const char *output = nullptr) {
    return DNN::CreateConv2D(_fbb, input ? _fbb.CreateString(input) : 0,
                             weight ? _fbb.CreateString(weight) : 0,
                             bias ? _fbb.CreateString(bias) : 0,
                             pads ? _fbb.CreateVector<int32_t>(*pads) : 0,
                             strides ? _fbb.CreateVector<int32_t>(*strides) : 0,
                             fuse, output ? _fbb.CreateString(output) : 0);
}
...
struct DepthwiseConv2D FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    int32_t multiplier() const { return GetField<int32_t>(VT_MULTIPLIER, 0); }
    FuseCode fuse() const {
        return static_cast<FuseCode>(GetField<int8_t>(VT_FUSE, 0));
    }
    const flatbuffers::String *output() const {
...
struct DepthwiseConv2DBuilder {
    ...
    void add_fuse(FuseCode fuse) {
        fbb_.AddElement<int8_t>(DepthwiseConv2D::VT_FUSE,
                                static_cast<int8_t>(fuse), 0);
    }
    void add_output(flatbuffers::Offset<flatbuffers::String> output) {
...
inline flatbuffers::Offset<DepthwiseConv2D> CreateDepthwiseConv2D(
    ...
    flatbuffers::Offset<flatbuffers::Vector<int32_t>> pads = 0,
    flatbuffers::Offset<flatbuffers::Vector<int32_t>> strides = 0,
    int32_t multiplier = 0, FuseCode fuse = FuseCode::None,
    flatbuffers::Offset<flatbuffers::String> output = 0) {
...
inline flatbuffers::Offset<DepthwiseConv2D> CreateDepthwiseConv2DDirect(
    ...
    const char *weight = nullptr, const char *bias = nullptr,
    const std::vector<int32_t> *pads = nullptr,
    const std::vector<int32_t> *strides = nullptr, int32_t multiplier = 0,
    FuseCode fuse = FuseCode::None, const char *output = nullptr) {
    return DNN::CreateDepthwiseConv2D(
        ...
        bias ? _fbb.CreateString(bias) : 0,
        pads ? _fbb.CreateVector<int32_t>(*pads) : 0,
        strides ? _fbb.CreateVector<int32_t>(*strides) : 0, multiplier, fuse,
        output ? _fbb.CreateString(output) : 0);
}
...
struct AvePoolBuilder {
    ...
    void add_kernel_shape(
        flatbuffers::Offset<flatbuffers::Vector<int32_t>> kernel_shape) {
    ...
    explicit AvePoolBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<AvePool> CreateAvePoolDirect(
    ...
    return DNN::CreateAvePool(
        ...
        pads ? _fbb.CreateVector<int32_t>(*pads) : 0,
        strides ? _fbb.CreateVector<int32_t>(*strides) : 0, fuse,
        output ? _fbb.CreateString(output) : 0);
}
...
struct MaxPoolBuilder {
    ...
    explicit MaxPoolBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
struct ReluBuilder {
    ...
    explicit ReluBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<Relu> CreateReluDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const char *input = nullptr,
    const char *output = nullptr) {
    return DNN::CreateRelu(_fbb, input ? _fbb.CreateString(input) : 0,
                           output ? _fbb.CreateString(output) : 0);
}
...
struct SoftmaxBuilder {
    ...
    explicit SoftmaxBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<Softmax> CreateSoftmaxDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const char *input = nullptr,
    const char *output = nullptr) {
    return DNN::CreateSoftmax(_fbb, input ? _fbb.CreateString(input) : 0,
                              output ? _fbb.CreateString(output) : 0);
}
...
struct FCBuilder {
    ...
    explicit FCBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<FC> CreateFCDirect(
    ...
    const char *weight = nullptr, const char *bias = nullptr,
    FuseCode fuse = FuseCode::None, const char *output = nullptr) {
    return DNN::CreateFC(_fbb, input ? _fbb.CreateString(input) : 0,
                         weight ? _fbb.CreateString(weight) : 0,
                         bias ? _fbb.CreateString(bias) : 0, fuse,
                         output ? _fbb.CreateString(output) : 0);
}

struct Add FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_INPUT1 = 4, VT_INPUT2 = 6, VT_FUSE = 8, VT_OUTPUT = 10 };
...
struct AddBuilder {
    ...
    explicit AddBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<Add> CreateAddDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const char *input1 = nullptr,
    const char *input2 = nullptr, FuseCode fuse = FuseCode::None,
    const char *output = nullptr) {
    return DNN::CreateAdd(_fbb, input1 ? _fbb.CreateString(input1) : 0,
                          input2 ? _fbb.CreateString(input2) : 0, fuse,
                          output ? _fbb.CreateString(output) : 0);
}

struct Concat FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_INPUTS = 4, VT_AXIS = 6, VT_OUTPUT = 8 };
    const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>
        *inputs() const {
        return GetPointer<const flatbuffers::Vector<
            flatbuffers::Offset<flatbuffers::String>> *>(VT_INPUTS);
    }
...
struct ConcatBuilder {
    ...
    explicit ConcatBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<Concat> CreateConcat(
    ...
    flatbuffers::Offset<
        flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>>
        inputs = 0,
    int32_t axis = 0, flatbuffers::Offset<flatbuffers::String> output = 0) {
...
inline flatbuffers::Offset<Concat> CreateConcatDirect(
    ...
    const std::vector<flatbuffers::Offset<flatbuffers::String>> *inputs =
        nullptr,
    int32_t axis = 0, const char *output = nullptr) {
    return DNN::CreateConcat(
        _fbb,
        inputs ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(
                     *inputs)
               : 0,
        axis, output ? _fbb.CreateString(output) : 0);
}
...
struct MulBuilder {
    ...
    explicit MulBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<Mul> CreateMulDirect(
    ...
    const char *input2 = nullptr, FuseCode fuse = FuseCode::None,
    const char *output = nullptr) {
    return DNN::CreateMul(_fbb, input1 ? _fbb.CreateString(input1) : 0,
                          input2 ? _fbb.CreateString(input2) : 0, fuse,
                          output ? _fbb.CreateString(output) : 0);
}
...
struct AddScalar FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    float input2() const { return GetField<float>(VT_INPUT2, 0.0f); }
    FuseCode fuse() const {
        return static_cast<FuseCode>(GetField<int8_t>(VT_FUSE, 0));
    }
    const flatbuffers::String *output() const {
...
struct AddScalarBuilder {
    ...
    void add_fuse(FuseCode fuse) {
        fbb_.AddElement<int8_t>(AddScalar::VT_FUSE, static_cast<int8_t>(fuse),
                                0);
    }
    void add_output(flatbuffers::Offset<flatbuffers::String> output) {
...
inline flatbuffers::Offset<AddScalar> CreateAddScalar(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::String> input1 = 0, float input2 = 0.0f,
    FuseCode fuse = FuseCode::None,
    flatbuffers::Offset<flatbuffers::String> output = 0) {
...
inline flatbuffers::Offset<AddScalar> CreateAddScalarDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const char *input1 = nullptr,
    float input2 = 0.0f, FuseCode fuse = FuseCode::None,
    const char *output = nullptr) {
    return DNN::CreateAddScalar(_fbb, input1 ? _fbb.CreateString(input1) : 0,
                                input2, fuse,
                                output ? _fbb.CreateString(output) : 0);
}
...
struct MulScalarBuilder {
    ...
    void add_fuse(FuseCode fuse) {
        fbb_.AddElement<int8_t>(MulScalar::VT_FUSE, static_cast<int8_t>(fuse),
                                0);
    }
    void add_output(flatbuffers::Offset<flatbuffers::String> output) {
...
inline flatbuffers::Offset<MulScalar> CreateMulScalarDirect(
    ...
    float input2 = 0.0f, FuseCode fuse = FuseCode::None,
    const char *output = nullptr) {
    return DNN::CreateMulScalar(_fbb, input1 ? _fbb.CreateString(input1) : 0,
                                input2, fuse,
                                output ? _fbb.CreateString(output) : 0);
}
...
inline flatbuffers::Offset<Dequantize> CreateDequantizeDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const char *input = nullptr,
    const char *output = nullptr) {
    return DNN::CreateDequantize(_fbb, input ? _fbb.CreateString(input) : 0,
                                 output ? _fbb.CreateString(output) : 0);
}
...
struct Layer FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    const FC *fc_param() const { return GetPointer<const FC *>(VT_FC_PARAM); }
    ...
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) &&
               ...
               verifier.VerifyTable(dequantize_param()) && verifier.EndTable();
    }
};
...
struct LayerBuilder {
    ...
    void add_depthwise_conv2d_param(
        flatbuffers::Offset<DepthwiseConv2D> depthwise_conv2d_param) {
        fbb_.AddOffset(Layer::VT_DEPTHWISE_CONV2D_PARAM,
                       depthwise_conv2d_param);
    }
    void add_batch_to_space_param(
        flatbuffers::Offset<BatchToSpace> batch_to_space_param) {
        fbb_.AddOffset(Layer::VT_BATCH_TO_SPACE_PARAM, batch_to_space_param);
    }
    void add_space_to_batch_param(
        flatbuffers::Offset<SpaceToBatch> space_to_batch_param) {
        fbb_.AddOffset(Layer::VT_SPACE_TO_BATCH_PARAM, space_to_batch_param);
    }
    void add_strided_slice_param(
        flatbuffers::Offset<StridedSlice> strided_slice_param) {
    ...
    void add_dequantize_param(
        flatbuffers::Offset<Dequantize> dequantize_param) {
...
struct Model FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    const flatbuffers::Vector<flatbuffers::Offset<Layer>> *layers() const {
        return GetPointer<
            const flatbuffers::Vector<flatbuffers::Offset<Layer>> *>(VT_LAYERS);
    }
    const flatbuffers::Vector<flatbuffers::Offset<Tensor>> *initializers()
        const {
        return GetPointer<
    ...
    const flatbuffers::Vector<flatbuffers::Offset<Input>> *inputs() const {
        return GetPointer<
            const flatbuffers::Vector<flatbuffers::Offset<Input>> *>(VT_INPUTS);
    }
    const flatbuffers::Vector<flatbuffers::Offset<QuantInfo>> *quant_infos()
        const {
        return GetPointer<
            const flatbuffers::Vector<flatbuffers::Offset<QuantInfo>> *>(
            VT_QUANT_INFOS);
    }
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) &&
...
struct ModelBuilder {
    ...
    void add_inputs(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Input>>>
            inputs) {
        fbb_.AddOffset(Model::VT_INPUTS, inputs);
    }
    void add_quant_infos(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<QuantInfo>>>
            quant_infos) {
...
inline flatbuffers::Offset<Model> CreateModelDirect(
    ...
    return DNN::CreateModel(
        ...
        initializers
            ? _fbb.CreateVector<flatbuffers::Offset<Tensor>>(*initializers)
            : 0,
        inputs ? _fbb.CreateVector<flatbuffers::Offset<Input>>(*inputs) : 0,
        quant_infos
            ? _fbb.CreateVector<flatbuffers::Offset<QuantInfo>>(*quant_infos)
            : 0);
}
...
inline void FinishSizePrefixedModelBuffer(
    flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<DNN::Model> root) {

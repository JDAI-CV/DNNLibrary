...
class ModelBuilder {
   ...
   public:
    ...
    Index AddMul(
        ...
        const std::string &output_name,
        const std::optional<QuantInfo> &output_quant_info = std::nullopt);
    Index AddReLU(const std::string &input_name,
                  const std::string &output_name);
    Index AddConcat(const std::vector<std::string> &input_names, int32_t axis,
                    const std::string &output_name);
    Index AddLRN(const std::string &input_name, int32_t local_size, float bias,
                 float alpha, float beta, const std::string &output_name);
    Index AddDequantize(const std::string &input_name,
                        const std::string &output_name);
#if __ANDROID_API__ >= __ANDROID_API_P__
    Index AddStridedSlice(const std::string &input_name,
                          ...
                          const std::string &output_name);
    Index AddSpaceToBatchND(const std::string &input_name,
                            const std::vector<int32_t> &block_sizes,
                            const std::vector<int32_t> &pads,
                            const std::string &output_name);
    Index AddBatchToSpaceND(const std::string &input_name,
                            const std::vector<int32_t> &block_sizes,
                            const std::string &output_name);
